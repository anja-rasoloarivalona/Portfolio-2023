...
import {
    ...
    Project,
    ProjectContent,
    ProjectContentCompanyName,
    ProjectContentDescription,
    ProjectContentPost,
    ProjectImage,
} from './HomeProjects-styles';
